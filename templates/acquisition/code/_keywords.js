gapi.analytics.ready(function() {
   ...
   */
  var keywordsChart_1 = new gapi.analytics.googleCharts.DataChart({
    query: {
    ...
    chart: {
      type: 'TABLE',
      container: 'keywords-container-1',
      options: {
        width: '100%'
      }
    }
  ...
  var keywordsChart_2 = new gapi.analytics.googleCharts.DataChart({
    query: {
      'metrics': 'ga:sessions,ga:bounceRate',
      'dimensions': 'ga:source',
      'start-date': '31daysAgo',
    ...
    chart: {
      type: 'TABLE',
      container: 'keywords-container-2',
      options: {
        width: '100%'
      }
    }
  ...
  viewSelector.on('viewChange', function(data) {
    ...
    keywordsChart_1.set(options).execute();
    ...
    keywordsChart_2.set(options).execute();
 });
  ...
  dateRangeSelector_1.on('change', function(data) {
    data['filters']='ga:channelGrouping==Organic Search';
  ...
  countryChart_1.on('success', function(response) {
    ...
    countryChartRowClickListener_1 = google.visualization.events
      ...
      var options = {
        query: {
          filters: 'ga:channelGrouping==Organic Search;ga:country==' + country
        },
        chart: {
          options: {
            title: country
